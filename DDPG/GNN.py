...
class Net(nn.Module):
    def __init__(self, s_dim_1, s_dim_2, hidden_size, out_dim, action_dim = 0):
        ...
        self.a11 = GCNLayer(s_dim_1, hidden_size)
        self.a12 = GCNLayer(hidden_size, hidden_size)
        self.a21 = GCNLayer(s_dim_2, hidden_size)
        self.a22 = GCNLayer(hidden_size, hidden_size)
