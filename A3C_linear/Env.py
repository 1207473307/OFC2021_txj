...
class Multicast_Env(object):
    def __init__(self, config, agent): #net_graph,  state_dim, action_dim, gnet, opt, global_ep, global_ep_r, res_queue, name,model_path=None, summary_writer=None):
        ...
        self.episodes_test = config.num_episodes_to_test
    ...
    def conduct(self, s, action):
        ...
        if action:
            ...
            if num_rerouting == 0 :
                ...
                return (l2-l1) + k1*(f2 - f1) - k2*num_rerouting, num_rerouting
        else:
            return 0, 0
    ...
    def run(self):
        ...
        while self.agent.global_step_number < self.episodes and num_episode < self.episodes_test:
            ...
            if self.agent.time_for_critic_and_actor_to_learn() and not self.test:
                self.agent.learn()
            ...
            if num_request % episode_size == 0:
                ...
                print("         num_rerouting: {},  Ep: {}".format(num_rerouting/num_session, num_rerouting_ep/num_session_ep))
